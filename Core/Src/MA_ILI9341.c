...
//2. Read data from LCD
uint8_t ILI9341_ReadData()
{
	return *(__IO uint8_t *)(0x60080000);
}
//2. Read data from LCD
uint32_t ILI9341_ReadData32()
{
	return *(__IO uint32_t *)(0x60080000);
}
uint16_t ILI9341_ReadData16()
{
...
//   //Read Display ID
//   ILI9341_SendCommand(0xD3);
//   uint16_t parm1 = ILI9341_ReadData();
//   uint16_t parm2 = ILI9341_ReadData();
//   uint16_t parm3 = ILI9341_ReadData();
//   uint16_t parm4 = ILI9341_ReadData();

//	//Read Display Status
//	ILI9341_SendCommand(0x09);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();
//	uint8_t parm3 = ILI9341_ReadData();
//	uint8_t parm4 = ILI9341_ReadData();
//	uint8_t parm5 = ILI9341_ReadData();

//	//Read Display Power Mode
//	ILI9341_SendCommand(0xA);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();

//	//Read Display MADCTL
//	ILI9341_SendCommand(0xB);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();

//	//Read Display Self-Diagnostic Result
//	ILI9341_SendCommand(0xF);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();

//	//Read Display Brightness
//	ILI9341_SendCommand(0x52);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();
//
//	//Read Display Signal Mode
//	ILI9341_SendCommand(0xE);
//	//	   HAL_Delay(1);
//	uint8_t parm1 = ILI9341_ReadData();
//	uint8_t parm2 = ILI9341_ReadData();

//	//Enable VSYNC interface
//	ILI9341_SendCommand(0xF6);
//	ILI9341_SendData(0x1);
//	ILI9341_SendData(0x0);
//	ILI9341_SendData(0x8);
//	HAL_Delay(5);

   //Repeatedly read and send scan line to serial console over UART
//   while(true) {
//	   //Read Scan line
//	   ILI9341_SendCommand(0x45);
////	   HAL_Delay(1);
//	   uint8_t parm1 = ILI9341_ReadData();
//	   uint8_t parm2 = ILI9341_ReadData();
//	   uint8_t parm3 = ILI9341_ReadData();
...
//	   scanline |= parm3;
//
//	   sprintf(user_msg, "Scan line returned = %d\r\n", scanline);
//	   HAL_UART_Transmit_IT(&huart2, (uint8_t *)user_msg, strlen(user_msg));
//	   HAL_Delay(1);
//   }
   HAL_Delay(100);
 }
...
void ILI9341_Display_Image(const tImage *pImage, unsigned long len) {
	//Send Memory Write command
	ILI9341_SendCommand(0x2C);

	//Parallel 2 byte method over single port
	const uint16_t *data = pImage->data;
